...
<nav aria-label="breadcrumb background-light text-right">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/irctc/waiting-cancellation">Report</a></li>
        ...
        <div class="col-md-12">
            <div class="box" id="printTable">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-8">
                            <h6 class="mb-0">Waiting Cancellation Details</h6>
                        </div>
                        <div class="col-md-4">
                            <button onclick="print('Waiting-cancellation-details.pdf')" id="noprint_btn" class="btn btn-sm m-0  btn-primary">Download</button>
                        </div>
                    </div>
                </div>
                <hr class="m-0">
                <div class="box-body ">
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <div class="view-font">
                                <label class="label-app">Reservation Id</label>
                                <h6>{{ $booking->reservationId }}</h6>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="view-font">
