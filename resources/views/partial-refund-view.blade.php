...
<nav aria-label="breadcrumb background-light text-right">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="http://localhost/irctcnew/public/partial-refund">Report</a></li>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="http://localhost/irctcnew/public/partial-refund" class="btn btn-sm m-0  btn-light">Back</a>
                        </div>
                    </div>
                </div>
                <hr class="m-0">
