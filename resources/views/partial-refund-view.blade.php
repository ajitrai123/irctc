...
<nav aria-label="breadcrumb background-light text-right">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/irctc">Home</a></li>
        <li class="breadcrumb-item"><a href="/irctc/partial-Refund">Report</a></li>
        ...
        <div class="col-md-12">
            <div class="box" id="printTable">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-8">
                            <h6 class="mb-0">Partial Refund Details</h6>
                        </div>
                        <div class="col-md-4">
                            <button onclick="print('Partial-Refund-details.pdf')" id="noprint_btn" class="btn btn-sm m-0  btn-primary">Download</button>
                        </div>
                    </div>
                </div>
                <hr class="m-0">
                <div class="box-body ">
                    <div class="row ">
                        <div class="col-md-4">
                            <div class="view-font">
                                <label class="label-app">Partial Refund Id</label>
                                <h6>{{ $partial_refund->id }}</h6>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="view-font">
                        ...
                        <div class="col-md-4">
                            <div class="view-font">
                                <label class="label-app">Cancellation Id</label>
                                <h6>{{ $partial_refund->cancellationId }}</h6>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="view-font">
                        ...
                        <div class="col-md-4">
                            <div class="view-font">
                                ...
                                @if ($partial_refund->status == 0)
                                <h6><span class="badge badge-warning px-2 py-1"><i class="bx bx-check-circle text-white"></i> {{ $partial_refund->responseStatus }}</span> </h6>                              
                                @elseif ($partial_refund->status == 1)
                                <h6><span class="badge badge-success px-2 py-1"><i class="bx bx-check-circle text-white"></i> {{ $partial_refund->responseStatus }}</span> </h6>                              
                                @else
                                <h6><span class="badge badge-danger px-2 py-1"><i class="bx bx-check-circle text-white"></i> {{ $partial_refund->responseStatus }}</span>  </h6>                             
                                @endif
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="view-font">
                                ...
                                <h6>{{ $partial_refund->responseMessage }}</h6>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="view-font">
                                <label class="label-app">Response Date</label>
                                <h6>{{ date("d/m/Y", strtotime($partial_refund->responseDate)); }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
